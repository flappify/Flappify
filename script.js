 ...
 * Nice to see you,
 * Hard work pays off.
 * Remember!!! there is always a scope for improvement.
 * Join us in our adventurous journey. FLAPPIFY always here with u. Email:flappify.creative@gmail.com
 **/
...
document.querySelector(".get-in-touch a").addEventListener("click",closeMenu);
...
function ProgressPos(){
  ...
  if(progress>2){
    ...
    document.querySelector(".navbar").classList.add("nav-pop");
  }
  else{
    document.querySelector(".progress-bar").style.width="0%";
    document.querySelector(".navbar").classList.remove("nav-pop");
